  ...
  function section(){
    ...
    <div class="report-container">
        <div class="report-header">
            ...
            <a href="categoryCreate.php" class="view">Add New</a>
        </div>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="categoryEdit.php?slug=<?= $slug ?>">Edit</a>
                                        <a class="dropdown-item" href="categoryDelete.php?id=<?= $id ?>" onclick="return confirm('Are you sure you want to delete this Category?');">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
